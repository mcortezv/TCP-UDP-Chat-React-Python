    ...
    return (
        <div className="relative grid min-h-[100vh] w-screen p-8">
            ...
            <div className="flex-col gap-2 pt-32 pb-40 text-center">
                <Typography variant="h1" color="blue-gray" className="text-7xl animate-float delay-2200">
                    Welcome to ING-CHAT
                </Typography>
                ...
                <div className="w-40 mx-auto mt-6 animate-pulse-slow">
                    <Button className="rounded-full">Entrar al Chat</Button>
                </div>
            </div>
            <div className="hidden md:block absolute top-[18%] left-[19%] animate-float-slow delay-100">
                <img
            ...
            <div className="hidden md:block absolute top-[12%] right-[26%] animate-float-slow delay-300">
                <img
            ...
            <div className="hidden md:block absolute bottom-[36%] left-[6%] animate-float-slow delay-1800">
                <img
            ...
            <div className="hidden md:block absolute bottom-[26%] left-[15%] animate-float-slow delay-900">
                <img
            ...
            <div className="grid grid-cols-1 gap-4 self-end md:grid-cols-2 lg:grid-cols-4">
                ...
                >
                    ...
                    >
                        ...
                        <Typography color="blue-gray" className="font-normal opacity-70">
                            Para iniciar el chat el usuario deber ingresar su nombre, podra acceder
                            a la sala de Chat y enviar mensajes que los otros usuarios podran ver.
                        </Typography>
                    </Card>
                </a>
                <a
                ...
                >
                    ...
                    >
                        ...
                        <Typography color="blue-gray" className="font-normal opacity-70">
                            Nuestro equipo esta conformado por David Escarcega y Manuel Cortez.
                        </Typography>
                    </Card>
                </a>
            </div>
